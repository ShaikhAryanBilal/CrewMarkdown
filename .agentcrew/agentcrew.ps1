...
# Usage: .\agentcrew.ps1 -List | -Step <id>
#
# AI agents: use .agentcrew/00-objectives.md for routing logic.
...
if ($List) {
  Write-Host "AgentCrew Steps:" -ForegroundColor Cyan
...
$helpMsg = @"
AgentCrew Index
  .\agentcrew.ps1 -List    (show all steps)
  .\agentcrew.ps1 -Step id (show step path)
  .\agentcrew.ps1 -Please  (polite mode)
  .\agentcrew.ps1 -Yell    (CAPS LOCK mode)

AI agents: read .agentcrew/00-objectives.md instead.
"@
