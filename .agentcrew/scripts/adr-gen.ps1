...
.PARAMETER OutputDir
ADR output directory (default: .agentcrew/procedures/adr)
.EXAMPLE
.\.agentcrew\scripts\adr-gen.ps1 -SourceLog ".agentcrew/logs/2026/06/10/meeting-minutes.md"
#>
...
$LogDir = Join-Path $ProjectRoot ".agentcrew" "logs"
if (-not $OutputDir) { $OutputDir = Join-Path $ProjectRoot ".agentcrew" "procedures" "adr" }
