<#
.SYNOPSIS
Pulls GitHub issues into .agentcrew/state/workflow.json as pending work items.
.PARAMETER Repo
GitHub repo in format owner/repo (e.g. "your-org/agentcrew")
.PARAMETER Label
...
.EXAMPLE
.\.agentcrew\scripts\issue-sync.ps1 -Repo "your-org/agentcrew" -Label "feature"
#>
