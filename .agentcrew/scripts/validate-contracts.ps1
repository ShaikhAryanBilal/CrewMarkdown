...
.PARAMETER RolesDir
Path to roles directory (default: .agentcrew/roles)
.EXAMPLE
.\.agentcrew\scripts\validate-contracts.ps1
#>
...
if (-not $RolesDir) { $RolesDir = Join-Path (Join-Path $ProjectRoot ".agentcrew") "roles" }
