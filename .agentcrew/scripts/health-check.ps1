<#
.SYNOPSIS
Validates .agentcrew/ directory structure: required files, directories, and JSON state.
.PARAMETER Quiet
Only output on failure
.EXAMPLE
.\.agentcrew\scripts\health-check.ps1
#>
...
if (-not $Quiet) {
  ...
  Write-Host " AgentCrew Health Check" -ForegroundColor Cyan
  Write-Host "============================================" -ForegroundColor Cyan
}

Test-Check -Name ".agentcrew directory exists" -Block { Test-Path $WorkflowDir }
